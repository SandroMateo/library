...
--
-- Name: librarians; Type: TABLE; Schema: public; Owner: Guest; Tablespace: 
--
...
ALTER TABLE librarians OWNER TO "Guest";

--
-- Name: librarians_id_seq; Type: SEQUENCE; Schema: public; Owner: Guest
--

CREATE SEQUENCE librarians_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE librarians_id_seq OWNER TO "Guest";

--
-- Name: librarians_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Guest
--

ALTER SEQUENCE librarians_id_seq OWNED BY librarians.id;
...
ALTER TABLE ONLY librarians ALTER COLUMN id SET DEFAULT nextval('librarians_id_seq'::regclass);
...
COPY books (id, title, author, patronid, checkoutdate, duedate, renewals) FROM stdin;
\.
...
--
-- Data for Name: librarians; Type: TABLE DATA; Schema: public; Owner: Guest
--

COPY librarians (id, username, password, name) FROM stdin;
\.


--
-- Name: librarians_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Guest
--

SELECT pg_catalog.setval('librarians_id_seq', 1, false);
...
COPY patrons (id, username, password, name, checkedbooks) FROM stdin;
\.
...
--
-- Name: librarians_pkey; Type: CONSTRAINT; Schema: public; Owner: Guest; Tablespace: 
--

ALTER TABLE ONLY librarians
